...
<body>
	...
	<h3>Welcome : Dr. ${sessionScope.name}</h3>
	<p>Please select your action:</p>

	<form method="post" action="/api/DoctorsAppointment">
		<button type="submit" name="user_type" value="">New
			Appointment</button>
	</form>
	<form method="get" action="/api/doctor-form">
		<button type="submit" name="doctor-form" value="doctor-form">Active Appointments</button>
	</form>
	<form method="get" action="/api/doctor">
		<button type="submit" name="doctor" value="doctor">All Appointments</button>
	</form>
	<br>
	<br>
	<br>
